          ...
          <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div className="text-sm lg:flex-grow">
              <a
                ...
                className="block mt-4 lg:inline-block lg:mt-0 text-[#7bc3d1] hover:text-[#EDE5A6] mr-4"
              >
                Domov
              </a>
              <a
              ...
              <a
                href="#responsive-header"
                className="block mt-4 lg:inline-block lg:mt-0 text-[#7bc3d1] hover:text-[#EDE5A6]"
              >
                Uporaba
              </a>
            </div>
